...
def before_request():
    ...
    if request.method == 'GET':
        get_list = [
            "/",
            "/apidocs/",
             "/pythonx0af865x/examusers/login" ,
            "/pythonx0af865x/examusers/register",
            '/pythonx0af865x/defaultuser/login',
            '/pythonx0af865x/users/login',
        ]  # 免认证list
        ...
        post_list = [
            '/pythonx0af865x/defaultuser/register',
            '/pythonx0af865x/defaultuser/login',
            '/pythonx0af865x/users/register',
            '/pythonx0af865x/users/login',
            "/pythonx0af865x/examusers/login" ,
            "/pythonx0af865x/examusers/register"
        ]  # 免认证list
