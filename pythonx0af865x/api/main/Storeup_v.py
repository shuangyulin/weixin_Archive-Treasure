...
# 注册接口
@main_bp.route("/pythonx0af865x/storeup/register", methods=['POST'])
def pythonx0af865x_storeup_register():
...
# 登录接口
@main_bp.route("/pythonx0af865x/storeup/login", methods=['GET','POST'])
def pythonx0af865x_storeup_login():
...
# 登出接口
@main_bp.route("/pythonx0af865x/storeup/logout", methods=['POST'])
def pythonx0af865x_storeup_logout():
    if request.method == 'POST':
        msg = {
            "msg": "退出成功",
            "code": 0
...
# 重置密码接口
@main_bp.route("/pythonx0af865x/storeup/resetPass", methods=['POST'])
def pythonx0af865x_storeup_resetpass():
    '''
    '''
    if request.method == 'POST':
...
# 获取会话信息接口
@main_bp.route("/pythonx0af865x/storeup/session", methods=['GET'])
def pythonx0af865x_storeup_session():
    '''
    '''
...
# 分类接口（后端）
@main_bp.route("/pythonx0af865x/storeup/page", methods=['GET'])
def pythonx0af865x_storeup_page():
    '''
    '''
    if request.method == 'GET':
...
# 排序接口
@main_bp.route("/pythonx0af865x/storeup/autoSort", methods=['GET'])
def pythonx0af865x_storeup_autosort():
    '''
    '''
    if request.method == 'GET':
        msg = {"code": normal_code, "msg": "success",  "data":{"currPage":1,"totalPage":1,"total":1,"pageSize":10,"list":[]}}
...
#查询单条数据
@main_bp.route("/pythonx0af865x/storeup/query", methods=['GET'])
def pythonx0af865x_storeup_query():
    if request.method == 'GET':
        msg = {"code": normal_code, "msg": "success",  "data":{}}
        req_dict = session.get("req_dict")
...
# 分页接口（前端）
@main_bp.route("/pythonx0af865x/storeup/list", methods=['GET'])
def pythonx0af865x_storeup_list():
    '''
    '''
    if request.method == 'GET':
        msg = {"code": normal_code, "msg": "success",  "data":{"currPage":1,"totalPage":1,"total":1,"pageSize":10,"list":[]}}
...
# 保存接口（后端）
@main_bp.route("/pythonx0af865x/storeup/save", methods=['POST'])
def pythonx0af865x_storeup_save():
    '''
    '''
    if request.method == 'POST':
        msg = {"code": normal_code, "msg": "success", "data": {}}
...
# 添加接口（前端）
@main_bp.route("/pythonx0af865x/storeup/add", methods=['POST'])
def pythonx0af865x_storeup_add():
    '''
    '''
    if request.method == 'POST':
        msg = {"code": normal_code, "msg": "success", "data": {}}
...
# 踩、赞接口
@main_bp.route("/pythonx0af865x/storeup/thumbsup/<id_>", methods=['GET'])
def pythonx0af865x_storeup_thumbsup(id_):
    '''
    '''
    if request.method == 'GET':
        msg = {"code": normal_code, "msg": "success", "data": {}}
...
# 获取详情信息（后端）
@main_bp.route("/pythonx0af865x/storeup/info/<id_>", methods=['GET'])
def pythonx0af865x_storeup_info(id_):
    '''
    '''
    if request.method == 'GET':
        msg = {"code": normal_code, "msg": "success", "data": {}}
...
# 获取详情信息（前端）
@main_bp.route("/pythonx0af865x/storeup/detail/<id_>", methods=['GET'])
def pythonx0af865x_storeup_detail(id_):
    '''
    '''
    if request.method == 'GET':
        msg = {"code": normal_code, "msg": "success", "data": {}}
...
# 更新接口
@main_bp.route("/pythonx0af865x/storeup/update", methods=['POST'])
def pythonx0af865x_storeup_update():
    '''
    '''
    if request.method == 'POST':
        msg = {"code": normal_code, "msg": "success", "data": {}}
...
# 删除接口
@main_bp.route("/pythonx0af865x/storeup/delete", methods=['POST'])
def pythonx0af865x_storeup_delete():
    '''
    '''
    if request.method == 'POST':
        msg = {"code": normal_code, "msg": "success", "data": {}}
...
# 投票接口
@main_bp.route("/pythonx0af865x/storeup/vote/<int:id_>", methods=['POST'])
def pythonx0af865x_storeup_vote(id_):
    '''
    '''
    if request.method == 'POST':
        msg = {"code": normal_code, "msg": "success"}
...
#分类列表
@main_bp.route("/pythonx0af865x/storeup/lists", methods=['GET'])
def pythonx0af865x_storeup_lists():
    if request.method == 'GET':
        msg = {"code": normal_code, "msg": "success", "data": []}
